 ...
 *
 * @author toli
 * @version $Id: FIXVersionTestSuite.java 16841 2014-02-20 19:59:04Z colin $
 */

@ClassVersion("$Id: FIXVersionTestSuite.java 16841 2014-02-20 19:59:04Z colin $") //$NON-NLS-1$
